...
print("<body><center>")
print("<h4><center>Prediction Of Turnover(in Lakhs) On The Basis Of Total Traded Quantity</center></h4>")
print("<form align='center' action='Submit_TT.py'>")
print("<table class='table table-bordered' align='center' style='font-size:12px;'>")
print("<tr><td><b>Enter Total Traded Quantity:</b></td>")
print("<td><input type='text' name='TT' class='form-control' id='year' required></td>")
print("</tr>")
print("</table>")
